...
> **Inicio:** 2026-07-24
> **Estado global:** 🚧 Plan aprobado; ejecución en curso.
...
|---|---|---|---|---|
| B1 | **Riesgo** | PATCH/DELETE con clave string `('ID')` devuelve 404 — posible error en URL-encoding del servidor con paréntesis para claves string | Alta | Pendiente |
| B2 | **Riesgo** | Finance dashboard no renderiza enlaces Facturas/Clientes/Pagos como texto plano detectable por `innerText` (hash routing + iconos) | Media | Pendiente |
...
- [x] P1.11, P3.1–P3.5 ✅ (15/18 tests PASS)
- [x] P3.6 ✅ — POST duplicado ahora responde 409 (UniqueConstraintError handle)
- Condición: fallos aquí implican bugs del servidor

> Resultados detallados: 7/8 checks PASS. Fallos identificados:
> - PATCH/DELETE con clave string devuelve 404 en lugar de 200/204 (B1 confirmado)
> - POST duplicado devuelve 500 en lugar de 409 (nuevo hallazgo B11)
> - Los 3 fallos son bugs del servidor en manejo de claves string, no de la UI.

### Fase 3 — UI Interactiva (P1.1–P1.10, P2.1–P2.10)
Flujo completo de usuario con Playwright.
- [ ] Filtros (P1.1–P1.6)
- [ ] CRUD diálogos (P1.7–P1.10)
- [ ] Edge cases (P2.1–P2.10)

### Fase 4 — Consolidación
- [ ] Generar reporte final
- [ ] Actualizar backlog con resultados
- [ ] Cerrar hallazgos resueltos
- [ ] Preparar PR a `master`
...
- [ ] P0: 9/9 checks PASS
- [ ] P1: ≥ 10/11 checks PASS
- [ ] P2: ≥ 8/10 checks PASS
- [ ] P3: documentado, sin umbral de fracaso
- [ ] Cero errores fatales en consola del navegador
- [ ] Backlog actualizado con hallazgos reales de la ejecución
